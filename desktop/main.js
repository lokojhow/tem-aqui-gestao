...
const PARTITION = 'persist:tem-aqui-gestao-v113';
      ...
      (async()=>{
        try {
          ...
          const ensureDesktopStyle=()=>{
            if(document.getElementById('desktopPdvFix113'))return;
            const style=document.createElement('style');
            style.id='desktopPdvFix113';
          ...
          ensureDesktopStyle();
          await loadLocalScript('desktopDialogFix113','./dialog-safety-fix.js?v=desktop-${DESKTOP_VERSION}');
          await loadLocalScript('desktopPosEnhancements113','./pos-enhancements.js?v=desktop-${DESKTOP_VERSION}');
          await loadLocalScript('desktopPosScanner113','./pos-hid-scanner.js?v=desktop-${DESKTOP_VERSION}');
