...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/app.js')){
    e.respondWith(Promise.all([
      ...
      fetch(new URL('./orders-detail-fix.js',self.location),{cache:'no-store'}).then(r=>r.text()),
    ...
    ]).then(([base,enh,barcode,mobileFixes,dialogFixes,storefront,foldable,installJs,orders,orderDetail,orderPerms,deepLink,logistics,productEdit,shareUniversal,mobileOrderFlow])=>{
