...
(() => {
  ...
  loadCss('customers-layout-fix.css?v=4','temAquiCustomersCss');
  loadScript('customers-credit-v2.js?v=4','temAquiCustomersCredit');
  loadScript('customers-list-v3.js?v=1','temAquiCustomersListV3');
})();
